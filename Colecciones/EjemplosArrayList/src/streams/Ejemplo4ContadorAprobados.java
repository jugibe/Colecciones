...
public class Ejemplo4ContadorAprobados {
	...
	public static void main(String[] args) {
		...
		long numeroAprobados = listaAlumnos.stream().filter(n -> n.getNota() >= 5).count();
		
		System.out.println("Alumnos aprobados: "+numeroAprobados);
